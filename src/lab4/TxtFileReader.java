...
/**
 * TxtFileReader is a low-level class that is used to read input data to a comma
 * separated value (.txt) file. This program uses the FileReaderStrategy
...
//            }
    ...
    public String getFileName() {
        ...
        try {
            System.out.println("Enter the file name to read from as filename.txt");
    ...
    public static void main(String[] args) throws NullPointerException, DataFormatException, IOException {
        String fn = null;
        TxtFileReader reader = new TxtFileReader(fn);
        reader.getFileName();
        reader.readFromFile();
    }
}